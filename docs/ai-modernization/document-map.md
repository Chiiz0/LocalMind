...
| [tracks/project-native-resources](./tracks/project-native-resources.md)       | Settled Project native storage, file trees, independent copies, explicit Workspace publishing and migration contract | Project resource ownership, internal editing, import, external publication or old-reference migration changes |
